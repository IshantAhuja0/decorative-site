  ...
  <div className="max-w-7xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      {[
        ...
        <div
          key={i}
          className="bg-white shadow-lg rounded-2xl p-6 text-left transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl animate-fade-in-up"
        >
    ...
    <section className="overflow-hidden">
      ...
      <div className="flex justify-center align-middle">
        <div
          ...
          className={`opacity-0 transform ${
            reverse ? "-translate-x-10" : "translate-x-10"
          } transition-all duration-700 text-center max-w-md`}
        >
          <img
            src={data.img}
            alt={data.title}
      ...
      <style>
        {`
          @keyframes slide-in {
            0% {
              transform: translateX(${reverse ? "-2.5rem" : "2.5rem"});
              opacity: 0;
            }
            100% {
