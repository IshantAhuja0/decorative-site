...
export default function About(props) {
  ...
  const stats = [
    { label: "Orders Fulfilled", value: Math.floor( daysPassed * 1.6) }, // +1.6 orders per day
    { label: "Happy Customers", value: Math.floor( daysPassed * 1.5) }, // +1.5 customers per day
    { label: "Projects Completed", value: 120 + Math.floor(daysPassed / 1.1) }, // 1 project every 10 days
